...
**12)  Undercloud - analyze Ansible Deployment log**

This mode is available for Python 2 version only and may help you to understand what went wrong while deployment procedure, basing on log generated by Ansible.
